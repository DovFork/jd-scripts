    ...
    return __generator(this, function (_2) {
        switch (_2.label) {
            ...
            case 2:
                ...
                _2.label = 3;
            case 3:
                if (!(i < cookiesArr.length)) return [3 /*break*/, 150];
                cookie = cookiesArr[i];
            ...
            case 59:
                _2.sent();
                if (!(res.dwCanLvlUp === 1 && res.ddwNextLvlCostCoin <= wallet)) return [3 /*break*/, 65];
            ...
            case 68:
                j++;
                return [3 /*break*/, 51];
            case 69: return [4 /*yield*/, api('story/GetTakeAggrPage', '_cfd_t,bizCode,dwEnv,ptag,source,strZone')];
            case 70:
                // 签到 助力奖励
                res = _2.sent();
                ...
                _2.label = 71;
            case 71:
                if (!(_l < employee_1.length)) return [3 /*break*/, 75];
                emp = employee_1[_l];
            ...
            case 74:
                ...
                return [3 /*break*/, 71];
            case 75:
                if (!(res.Data.Sign.dwTodayStatus === 0)) return [3 /*break*/, 80];
                console.log('今日未签到');
                _m = 0, _o = res.Data.Sign.SignList;
                _2.label = 76;
            case 76:
                if (!(_m < _o.length)) return [3 /*break*/, 79];
                sign = _o[_m];
                if (!(sign.dwDayId === res.Data.Sign.dwTodayId)) return [3 /*break*/, 78];
            ...
            case 84:
                _2.sent();
                if (!res.StoryInfo.StoryList) return [3 /*break*/, 104];
                if (!res.StoryInfo.StoryList[0].Mermaid) return [3 /*break*/, 91];
                console.log("\u53D1\u73B0\u7F8E\u4EBA\u9C7C\uD83E\uDDDC\u200D\u2640\uFE0F");
            ...
            case 86:
                _2.sent();
                if (!(MermaidRes.iRet === 0)) return [3 /*break*/, 88];
            ...
            case 87:
                ...
                _2.label = 88;
            case 88: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(1000)];
            case 89:
                _2.sent();
                return [4 /*yield*/, api('story/MermaidOper', '_cfd_t,bizCode,ddwTriggerDay,dwEnv,dwType,ptag,source,strStoryId,strZone', {
                        strStoryId: res.StoryInfo.StoryList[0].strStoryId,
            ...
            case 92:
                _2.sent();
                if (!res.StoryInfo.StoryList[0].Special) return [3 /*break*/, 96];
            ...
            case 96:
                isCollector = false;
                if (!res.StoryInfo.StoryList[0].Collector) return [3 /*break*/, 102];
                console.log('收藏家出现');
            ...
            case 100:
                ...
                if (!(bags_1.length !== 0)) return [3 /*break*/, 102];
            ...
            case 103:
                _2.sent();
                _2.label = 104;
            case 104: return [4 /*yield*/, api('story/querystorageroom', '_cfd_t,bizCode,dwEnv,ptag,source,strZone')];
            case 105:
                // 清空背包
                res = _2.sent();
                bags = [];
            ...
            case 106:
                ...
                if (!(bags.length !== 0)) return [3 /*break*/, 108];
            ...
            case 107:
                ...
                console.log('卖贝壳收入:', res.Data.ddwCoin, res.Data.ddwMoney);
                _2.label = 108;
            case 108: return [4 /*yield*/, api('story/QueryRubbishInfo', '_cfd_t,bizCode,dwEnv,ptag,source,strZone')];
            case 109:
                // 垃圾🚮
                res = _2.sent();
                if (!(res.Data.StoryInfo.StoryList.length !== 0)) return [3 /*break*/, 116];
                console.log('有垃圾');
            ...
            case 123:
                _t++;
                return [3 /*break*/, 120];
            case 124: return [4 /*yield*/, api('story/GetActTask', '_cfd_t,bizCode,dwEnv,ptag,source,strZone')];
            case 125:
                tasks = _2.sent();
                return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(2000)];
            case 126:
                ...
                _2.label = 127;
            case 127:
                if (!(_v < _w.length)) return [3 /*break*/, 131];
                t = _w[_v];
                if (!(t.dwCompleteNum === t.dwTargetNum && t.dwAwardStatus === 2)) return [3 /*break*/, 130];
            ...
            case 130:
                _v++;
                return [3 /*break*/, 127];
            case 131: return [4 /*yield*/, api('story/GetActTask', '_cfd_t,bizCode,dwEnv,ptag,source,strZone')];
            case 132:
                tasks = _2.sent();
                return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(2000)];
            case 133:
                _2.sent();
                if (!(tasks.Data.dwStatus === 3)) return [3 /*break*/, 135];
            ...
            case 137:
                // 导游
                res = _2.sent();
                if (!!res.TourGuideList) return [3 /*break*/, 138];
            ...
            case 138:
                ...
                _2.label = 139;
            case 139:
                if (!(_x < _y.length)) return [3 /*break*/, 143];
                e = _y[_x];
                if (!(e.strBuildIndex !== 'food' && e.ddwRemainTm === 0)) return [3 /*break*/, 142];
            ...
            case 144:
                ...
                _2.label = 145;
            case 145:
                if (!(_z < _0.length)) return [3 /*break*/, 149];
                b = _0[_z];
            ...
            case 150:
                ...
                _2.label = 151;
            case 151:
                if (!(i < cookiesArr.length)) return [3 /*break*/, 162];
            ...
            case 156:
                ...
                _2.label = 157;
            case 157:
                if (!(j < shareCodes.length)) return [3 /*break*/, 161];
                cookie = cookiesArr[i];
