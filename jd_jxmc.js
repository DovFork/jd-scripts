...
!(function () { return __awaiter(void 0, void 0, void 0, function () {
    var cookiesArr, except, i, j, lastgettime, food, petid, coins, e_1, tasks, _i, _a, t, j, _b, _c, card, drawTimes, j, e_2, cowToken, _d, _e, day, j, _f, _g, t, e_3, e_4, i, data, e_5, j, i, data, e_6, j;
    var _h, _j;
    return __generator(this, function (_k) {
        switch (_k.label) {
            ...
            case 17:
                ...
                t = _a[_i];
                if (!(t.awardStatus === 2)) return [3 /*break*/, 26];
            ...
            case 29:
                ...
                if (!(card.currnum >= card.neednum)) return [3 /*break*/, 31];
                console.log('可以兑换');
                // TODO 兑换卡片
            ...
            case 40:
                j++;
                return [3 /*break*/, 36];
            case 41: return [4 /*yield*/, api('operservice/GetInviteStatus', 'activeid,activekey,channel,jxmc_jstoken,phoneid,sceneid,timestamp')];
            case 42:
                // 红包
                res = _k.sent();
            ...
            case 45:
                e_2 = _k.sent();
                return [3 /*break*/, 46];
            case 46: return [4 /*yield*/, cow(lastgettime)];
            case 47:
                cowToken = _k.sent();
            ...
            case 50:
                // 签到
                res = _k.sent();
                if (!res.data.signlist) return [3 /*break*/, 55];
                _d = 0, _e = res.data.signlist;
                _k.label = 51;
            case 51:
                if (!(_d < _e.length)) return [3 /*break*/, 54];
                day = _e[_d];
                if (!(day.fortoday && !day.hasdone)) return [3 /*break*/, 53];
            ...
            case 55:
                ...
                _k.label = 56;
            case 56: return [4 /*yield*/, api('queryservice/GetVisitBackInfo', 'activeid,activekey,channel,jxmc_jstoken,phoneid,sceneid,timestamp')];
            case 57:
                // 登录领白菜
                res = _k.sent();
                if (!(res.iscandraw === 1)) return [3 /*break*/, 59];
            ...
            case 64:
                ...
                _k.label = 65;
            case 65:
                if (!(coins >= 5000 && food <= 500)) return [3 /*break*/, 68];
            ...
            case 67:
                _k.sent();
                return [3 /*break*/, 65];
            case 68: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(3000)];
            case 69:
                _k.sent();
                console.log('food:', food, food >= 10);
                _k.label = 70;
            case 70:
                if (!(food >= 10)) return [3 /*break*/, 78];
                return [4 /*yield*/, api('operservice/Feed', 'activeid,activekey,channel,jxmc_jstoken,phoneid,sceneid,timestamp')];
            case 71:
                res = _k.sent();
                if (!(res.ret === 0)) return [3 /*break*/, 72];
                food -= 10;
                console.log('剩余草:', res.data.newnum);
                return [3 /*break*/, 76];
            case 72:
                if (!(res.ret === 2020)) return [3 /*break*/, 75];
                console.log('收🥚');
            ...
            case 75:
                ...
                _k.label = 76;
            case 76: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(6000)];
            case 77:
                _k.sent();
                return [3 /*break*/, 70];
            case 78: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(3000)];
            case 79:
                _k.sent();
                _k.label = 80;
            case 80:
                if (!1) return [3 /*break*/, 89];
                _k.label = 81;
            case 81:
                _k.trys.push([81, 87, , 88]);
            ...
            case 83:
                _k.sent();
                if (!res.data.surprise) return [3 /*break*/, 86];
            ...
            case 87:
                ...
                return [3 /*break*/, 89];
            case 88: return [3 /*break*/, 80];
            case 89: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(5000)];
            case 90:
                _k.sent();
                _k.label = 91;
            case 91:
                if (!1) return [3 /*break*/, 97];
                _k.label = 92;
            case 92:
                _k.trys.push([92, 95, , 96]);
            ...
            case 111:
                ...
                _k.label = 112;
            case 112:
                if (!(i < cookiesArr.length)) return [3 /*break*/, 124];
                return [4 /*yield*/, getCodes()
                    // 获取随机助力码
                ];
            case 113:
            ...
            case 118:
                ...
                _k.label = 119;
            case 119:
                if (!(j < shareCodes.length)) return [3 /*break*/, 123];
                console.log("\u8D26\u53F7" + (i + 1) + "\u53BB\u52A9\u529B" + shareCodes[j]);
