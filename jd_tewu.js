    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 11:
                ...
                t = _c[_b];
                if (!!t.completionFlag) return [3 /*break*/, 26];
            ...
            case 21:
                ...
                if (!(t.assignmentName === '邀请好友')) return [3 /*break*/, 26];
                ...
                _g.label = 22;
            case 22:
                if (!(j < t.cardAssistBoxRest)) return [3 /*break*/, 26];
            ...
            case 35:
                ...
                _g.label = 36;
            case 36:
                if (!(_f < shareCode_1.length)) return [3 /*break*/, 45];
                code = shareCode_1[_f];
