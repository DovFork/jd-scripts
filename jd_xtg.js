...
function api() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1["default"].post("https://api.m.jd.com/api", "appid=china-joy&functionId=star_push_jd_prod&body={\"apiMapping\":\"/api/task/doSign\"}&t=" + Date.now(), {
                        headers: {
                            'Host': 'api.m.jd.com',
