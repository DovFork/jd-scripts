...
!(function () { return __awaiter(void 0, void 0, void 0, function () {
    var cookiesArr, except, i, j, lastgettime, food, petid, coins, petNum, e_1, tasks, _i, _a, t, j, drawTimes, j, _b, _c, card, e_2, e_3, _d, _e, day, j, _f, _g, t, e_4, e_5, i, data, e_6, j, i, data, e_7, j;
    var _h, _j;
    return __generator(this, function (_k) {
        switch (_k.label) {
            ...
            case 40:
                ...
                if (!(card.currnum >= card.neednum && petNum < 6)) return [3 /*break*/, 43];
                console.log('可以兑换');
            ...
            case 71:
                ...
                _k.label = 72;
            case 72:
                if (!(coins >= 5000 && food <= 500)) return [3 /*break*/, 75];
            ...
            case 74:
                _k.sent();
                return [3 /*break*/, 72];
            case 75: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(3000)];
            case 76:
                _k.sent();
                _k.label = 77;
            case 77:
                if (!(food >= 10)) return [3 /*break*/, 85];
                return [4 /*yield*/, api('operservice/Feed', 'activeid,activekey,channel,jxmc_jstoken,phoneid,sceneid,timestamp')];
            case 78:
                res = _k.sent();
                if (!(res.ret === 0)) return [3 /*break*/, 79];
                food -= 10;
                console.log('剩余草:', res.data.newnum);
                return [3 /*break*/, 83];
            case 79:
                if (!(res.ret === 2020)) return [3 /*break*/, 82];
                console.log('收🥚');
            ...
            case 86:
                ...
                _k.label = 87;
            case 87:
                if (!1) return [3 /*break*/, 96];
                _k.label = 88;
            case 88:
                _k.trys.push([88, 94, , 95]);
            ...
            case 90:
                _k.sent();
                if (!res.data.surprise) return [3 /*break*/, 93];
            ...
            case 94:
                ...
                return [3 /*break*/, 96];
            case 95: return [3 /*break*/, 87];
            case 96: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(5000)];
            case 97:
                _k.sent();
                _k.label = 98;
            case 98:
                if (!1) return [3 /*break*/, 104];
                _k.label = 99;
            case 99:
                _k.trys.push([99, 102, , 103]);
            ...
            case 102:
                ...
                return [3 /*break*/, 104];
            case 103: return [3 /*break*/, 98];
            case 104:
                i++;
                return [3 /*break*/, 3];
            case 105: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(3000)];
            case 106:
                _k.sent();
                i = 0;
                _k.label = 107;
            ...
            case 119:
                ...
                _k.label = 120;
            case 120:
                if (!(i < cookiesArr.length)) return [3 /*break*/, 132];
                return [4 /*yield*/, getCodes()
                    // 获取随机助力码
                ];
            case 121:
            ...
            case 126:
                ...
                _k.label = 127;
            case 127:
                if (!(j < shareCodes.length)) return [3 /*break*/, 131];
                console.log("\u8D26\u53F7" + (i + 1) + "\u53BB\u52A9\u529B" + shareCodes[j]);
