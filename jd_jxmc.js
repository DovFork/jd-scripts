...
!(function () { return __awaiter(void 0, void 0, void 0, function () {
    var cookiesArr, except, i, j, lastgettime, food, petid, coins, e_1, tasks, _i, _a, t, j, drawTimes, j, _b, _c, card, e_2, e_3, _d, _e, day, j, _f, _g, t, e_4, e_5, i, data, e_6, j, i, data, e_7, j;
    var _h, _j;
    return __generator(this, function (_k) {
        switch (_k.label) {
            ...
            case 2:
                ...
                _k.label = 3;
            case 3:
                if (!(i < cookiesArr.length)) return [3 /*break*/, 101];
                cookie = cookiesArr[i];
            ...
            case 45:
                e_2 = _k.sent();
                return [3 /*break*/, 46];
            case 46: return [4 /*yield*/, api('operservice/GetInviteStatus', 'activeid,activekey,channel,jxmc_jstoken,phoneid,sceneid,timestamp')];
            case 47:
                // 红包
                res = _k.sent();
            ...
            case 50:
                e_3 = _k.sent();
                return [3 /*break*/, 51];
            case 51: return [4 /*yield*/, api('queryservice/GetSignInfo', 'activeid,activekey,channel,jxmc_jstoken,phoneid,sceneid,timestamp')];
            case 52:
                // 签到
                res = _k.sent();
                if (!res.data.signlist) return [3 /*break*/, 57];
                _d = 0, _e = res.data.signlist;
                _k.label = 53;
            case 53:
                if (!(_d < _e.length)) return [3 /*break*/, 56];
                day = _e[_d];
                if (!(day.fortoday && !day.hasdone)) return [3 /*break*/, 55];
            ...
            case 57:
                ...
                _k.label = 58;
            case 58: return [4 /*yield*/, api('queryservice/GetVisitBackInfo', 'activeid,activekey,channel,jxmc_jstoken,phoneid,sceneid,timestamp')];
            case 59:
                // 登录领白菜
                res = _k.sent();
                if (!(res.iscandraw === 1)) return [3 /*break*/, 61];
            ...
            case 67:
                ...
                _k.label = 68;
            case 68:
                if (!(coins >= 5000 && food <= 500)) return [3 /*break*/, 71];
            ...
            case 70:
                _k.sent();
                return [3 /*break*/, 68];
            case 71: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(3000)];
            case 72:
                _k.sent();
                console.log('food:', food, food >= 10);
                _k.label = 73;
            case 73:
                if (!(food >= 10)) return [3 /*break*/, 81];
                return [4 /*yield*/, api('operservice/Feed', 'activeid,activekey,channel,jxmc_jstoken,phoneid,sceneid,timestamp')];
            case 74:
                res = _k.sent();
                if (!(res.ret === 0)) return [3 /*break*/, 75];
                food -= 10;
                console.log('剩余草:', res.data.newnum);
                return [3 /*break*/, 79];
            case 75:
                if (!(res.ret === 2020)) return [3 /*break*/, 78];
                console.log('收🥚');
            ...
            case 78:
                ...
                _k.label = 79;
            case 79: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(6000)];
            case 80:
                _k.sent();
                return [3 /*break*/, 73];
            case 81: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(3000)];
            case 82:
                _k.sent();
                _k.label = 83;
            case 83:
                if (!1) return [3 /*break*/, 92];
                _k.label = 84;
            case 84:
                _k.trys.push([84, 90, , 91]);
            ...
            case 86:
                _k.sent();
                if (!res.data.surprise) return [3 /*break*/, 89];
            ...
            case 90:
                ...
                return [3 /*break*/, 92];
            case 91: return [3 /*break*/, 83];
            case 92: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(5000)];
            case 93:
                _k.sent();
                _k.label = 94;
            case 94:
            ...
            case 108:
                ...
                _k.label = 109;
            case 109:
                if (!(j < shareCodes.length)) return [3 /*break*/, 113];
